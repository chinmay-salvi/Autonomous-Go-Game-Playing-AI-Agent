...
def judge(n_move, piece_type, previous_board, board, action, x, y, verbose):
    go = GO(5)
    ...
    if action == "MOVE":
        if not go.place_chess(x, y, piece_type):
            print("Game end.")
            print("--X The winner is {}".format("X" if 3 - piece_type == 1 else "O"))
...
if __name__ == "__main__":
    ...
    judge(args.move, args.verbose == "True")
